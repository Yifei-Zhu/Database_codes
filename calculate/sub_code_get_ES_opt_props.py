...
class Gaussian16_ES(Gaussian16):
   ...
   def count_OrbNum_HomoLumo(self):
      ...
      return [int(occupied_count), int(occupied_count+1)]
...
if __name__ == '__main__':
   # main()
   main_import('/data/home/zhuyf/dataset_work/database/qm9_database/Gaussian_gau_excited_wb97xd/1000/1000.log','./aaa.dat','sp')
